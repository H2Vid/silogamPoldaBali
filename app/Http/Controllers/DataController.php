    ...
    public function index($slug, Request $request)
    {
        ...
        $dataKabag = [
            ...
            [
                ...
                'title' => 'KOMPOL NI LUH PUTU ANNE PARWISTI, S.H., M.Si.',
                'subtitle' => 'KASUBBAGRENMIN RO SDM POLDA BALI',
            ],
    ...
    public function showSubcategory($slug, Request $request)
    {
        ...
        $dataKabag = [
            ...
            [
                ...
                'title' => 'KOMPOL KRISNA DEWI, S.H.',
                'subtitle' => 'KASUBBAGDIAPERS BAGDALPERS RO SDM POLDA BALI',
            ],
            [
                'slug' => 'subbagselek',
                'image' => 'KASUBBAG SELEKSI.png',
                'title' => 'KOMPOL DWI INDAR KOESWOYO, S.Psi., M.Psi.',
                'subtitle' => 'KASUBBAGSELEK BAGDALPERS RO SDM POLDA BALI',
            ],
            [
                'slug' => 'subbagpns',
                'bg'=>'biru',
                'image' => 'KASUBBAGPNS.png',
                'title' => 'PENATA I GUSTI AYU MADE ARTINI,S.E.',
                'subtitle' => 'PS. KASUBBAG PNS BAGDALPERS RO SDM POLDA BALI',
            ],
            [
                'slug' => 'subbagmutjab',
                'image' => 'KASUBBAGMUTJAB.png',
                'title' => 'KOMPOL VICKY TRI HARYANTO, S.H., S.I.K., M.H.',
                'subtitle' => 'KASUBBAGMUTJAB BAGBINKAR RO SDM POLDA BALI',
            ],
            [
                'slug' => 'subbagpangkat',
                'image' => 'KASUBBAGPANGKAT.png',
                'title' => 'KOMPOL PUTU DIAH KURNIAWANDARI, S.H., S.I.K., M.H.',
                'subtitle' => 'KASUBBAGPANGKAT BAGBINKAR RO SDM POLDA BALI',
            ],
            [
                'slug' => 'subbagkompeten',
                'image' => 'KASUBBAGKOMPETEN.png',
                'title' => 'KOMPOL NI MADE BUDHI ARTINI, S.H., M.H.',
                'subtitle' => 'KASUBBAGKOMPETEN BAGBINKAR RO SDM POLDA BALI',
            ],
            [
                'slug' => 'subbagrohjashor',
                'image' => 'PLT_KABAGWATPERS.png',
                'title' => 'KOMPOL ANAK AGUNG GEDE ARKA, S.H., M.H.',
                'subtitle' => 'KASUBBAGROHJASHOR BAGWATPERS RO SDM POLDA BALI',
            ],
            [
                'slug' => 'subbagkhirdinlur',
                'image' => 'KASUBBAG KHIRIDNLUR.png',
                'title' => 'KOMPOL DARYANI, S.I.K., M.H.',
                'subtitle' => 'KASUBBAGKHIRDINLUR BAGWATPERS RO SDM POLDA BALI',
            ],
            [
                'slug' => 'subbagpsipol',
                'image' => 'KASUBBAGPSIPOL.png',
                'bg'=>'biru',
                'title' => 'PEMBINA I KETUT GEDE SANTIASA, MPSI, S.Psi., M.Psi.',
                'subtitle' => 'PS. KASUBBAGPSIPOL BAGPSI RO SDMPOLDA BALI',
            ],
            [
                'slug' => 'subbagpsipers',
                'bg'=>'biru',
                'image' => 'KASUBBAGPSIPERS.png',
                'title' => 'PEMBINA I GUSTI PUTU ARI PRAMESTI, S.Psi.,',
                'subtitle' => 'PS. KASUBBAGPSIPERS BAGPSI RO SDM POLDA BALI',
            ],
